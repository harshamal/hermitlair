...
const spaces = [
    ...
    {
        name: "The Library",
        description: "Wisdom from centuries, waiting to be discovered",
        icon: Leaf,
        details: "Shelves lined with books on mindfulness, philosophy, nature, and transformation. Comfortable reading nooks. A fireplace for cool evenings. Take a book to your room or lose yourself here for hours.",
    },
    {
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-serif text-shadow mb-8 tracking-tight" style={{ fontWeight: 300 }}>
                            Built with
                            <span className="text-sage-dark italic"> Intention</span>
                        </h2>
                    </motion.div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-serif text-shadow mb-6 tracking-tight" style={{ fontWeight: 300 }}>
                            Your
                            <span className="text-sage-dark italic"> Chamber</span>
                        </h2>
                        <p className="text-lg text-stone-light font-light max-w-2xl mx-auto">
                            Each room is a sanctuary within the sanctuary—simple, beautiful, and designed for rest
                        </p>
                    </motion.div>
                        ...
                        {rooms.map((room, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h3 className="text-2xl font-serif text-shadow mb-3 tracking-tight">
                                        {room.name}
                                    </h3>
                                    <p className="text-stone-light font-light mb-6 leading-relaxed">
                                        {room.description}
                                    </p>
                                    ...
                                    <ul className="space-y-2">
                                        {room.features.map((feature, i) => (
                                            <li key={i} className="flex items-center gap-2 text-sm text-stone-light">
                    ...
                    <motion.div
                        ...
                        className="mt-16 p-8 rounded-3xl bg-champagne/10 border border-champagne/20"
                    >
                        <p className="text-center text-stone-light font-light leading-relaxed">
                            <strong className="text-shadow font-medium">All rooms include:</strong> Organic cotton linens,
                            natural toiletries, filtered water, meditation cushions, journals, and views that will make
            ...
            <section className="relative py-32 px-6 bg-gradient-to-b from-linen to-mist">
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-serif text-shadow mb-6 tracking-tight" style={{ fontWeight: 300 }}>
                            Sacred
                            <span className="text-sage-dark italic"> Spaces</span>
                        </h2>
                        <p className="text-lg text-stone-light font-light max-w-2xl mx-auto">
                            Beyond your room, the entire sanctuary is yours to explore
                        </p>
                    </motion.div>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-4 mb-4">
                                        <div className="p-3 rounded-2xl bg-champagne/10 flex-shrink-0">
                                            <Icon className="w-6 h-6 text-champagne" />
                                        </div>
                                        <div>
                                            <h3 className="text-2xl font-serif text-shadow mb-2">
                                                {space.name}
                                            </h3>
                                            <p className="text-sage-dark font-medium italic mb-3">
                                                {space.description}
                                            </p>
                                        </div>
                                    </div>
